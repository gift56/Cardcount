...
// Using for loop in iterating through in extracting data
...
const new_ss = ss.myFilter(function (item) {
    return item % 2 === 1;
});

// Using the slice method in removing thing in an array
...
// Deleting some items using filter and map method in doing it 
// The global variable
const watchListF = [
    {
        "Title": "Inception",
...
function getRating(watchList) {
    ...
    const averageRating = watchList
        ...
        watchListF.filter(film => film.Director === "Christopher Nolan").length;
...
console.log(getRating(watchListF));

// Using onl map(),filter() amd redue() in finding only positive value
